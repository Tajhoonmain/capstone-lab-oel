...
\subsection{Pipeline Execution Evidence}
The following screenshots demonstrate the execution of the CI/CD pipeline in GitHub Actions, including the multi-job workflow containing linting, unit testing, and the evaluation quality gate.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{pipeline_screenshot.png} 
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{failure_screenshot.png} 
    \caption{Detailed Job Output for Pipeline Run}
    \label{fig:failure}
\end{figure}
