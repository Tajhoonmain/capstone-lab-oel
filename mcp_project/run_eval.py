...
def run_headless_eval():
    ...
    for i, test in enumerate(test_suite):
        ...
        try:
            for event in multi_agent_app.stream({"messages": [HumanMessage(content=test["question"])], "sender": "user"}, config, stream_mode="values"):
    ...
    final_metrics = {
        ...
        "relevancy_score": avg_relevancy_score
    }
