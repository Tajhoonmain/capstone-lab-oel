...
app = FastAPI(
    title="Academic Advisor API", description="Agentic LangGraph Backend for Student Advising", version="1.0.0"
)
                ...
                for node_name, node_state in event.items():
                    if "messages" in node_state:
                        ...
                        if hasattr(last_msg, "tool_calls") and last_msg.tool_calls:
                            ...
                            payload = json.dumps(
                                {"node": node_name, "type": "tool_call", "content": f"Calling tool: {tool_name}..."}
                            )
