...
def guardrail_node(state: AgentState):
    ...
    for phrase in forbidden_phrases:
        if phrase in user_query:
            ...
            return {
                "messages": [AIMessage(content="Security Violation: I am an Academic Advisor AI. I cannot process this request.")],
                "is_safe": False
            }
    ...
    if not is_academic:
        ...
        return {
            "messages": [AIMessage(content="Out of Bounds: I am strictly an Academic Advisor. I can only assist with grades, courses, and university policies.")],
            "is_safe": False
        }
