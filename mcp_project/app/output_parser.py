...
class StudentResponse(BaseModel):
    ...
    summary: str = Field(description="A concise, 1-sentence summary of the answer.")
    detailed_explanation: str = Field(description="The full, polite explanation of the academic policy or calculation.")
    suggested_next_steps: list[str] = Field(description="A list of 1-3 actionable next steps the student can take.")
